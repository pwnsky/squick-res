...
file_desc='''// Generated by the res/Tools/proto/gen_msgid.py.  DO NOT EDIT!
// Update time: ''' + str(current_time) + "\n"

# Generate msg_id.proto
def generate_proto_file():
    with open(res_path + '/Proto/msg_id.proto', 'w+', encoding='utf-8') as out:
        out.write(file_desc)
        out.write('''
syntax = "proto3";
package rpc;
...
def generate_node_proto_file():
    with open(res_path + '/Proto/n_msg_id.proto', 'w+', encoding='utf-8') as out:
        out.write(file_desc)
        out.write('''
syntax = "proto3";
package rpc;
...
def generate_cpp_file():
    with open(res_path + '/ProtoCode/Cpp/msg_id.cc', 'w+', encoding='utf-8') as cc_file:
    ...
    with open(res_path + '/ProtoCode/Cpp/msg_id.h', 'w+', encoding='utf-8') as h_file:
